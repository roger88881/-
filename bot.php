...
file_put_contents("roger/_ad.txt", $botuser);
function stats($nn) {
$st = "";
...
[['text' => "- قناة تيم الشايب -'", 'url' => "https://t.me/TimALshayeb"]],
]]) 
]);
}
if ($chat_id == $group) {
...
$up_file = curl_get("https://raw.githubusercontent.com/rogerx/roger/main/bot.php");
...
$up_file = curl_get("https://raw.githubusercontent.com/rogerx/roger/main/1.php");
file_put_contents("1.php",$up_file);
$up_file = curl_get("https://raw.githubusercontent.com/rogerx/roger/main/2.php");
file_put_contents("2.php",$up_file);
$up_file = curl_get("https://raw.githubusercontent.com/rogerx/roger/main/3.php");
file_put_contents("3.php",$up_file);
$up_file = curl_get("https://raw.githubusercontent.com/rogerx/roger/main/4.php");
file_put_contents("4.php",$up_file);
$up_file = curl_get("https://raw.githubusercontent.com/rogerx/roger/main/5.php");
...
$up_file = curl_get("https://raw.githubusercontent.com/rogerx/roger/main/madeline.php");
...
bot('sendMessage', ['chat_id' => $chat_id,'text'=>"⌁ Done Stoped Checker \n⌁ Checker Stoped List ".$ex[1]." 🔐",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "قناة تيم الشايب", 'url' => "https://t.me/TimALshayeb"]],]])]);
$info = json_decode(file_get_contents('info.json'),true);
$info["num".$ex[1]] = "off";
file_put_contents('info.json', json_encode($info));
}
...
bot('sendMessage', ['chat_id' => $chat_id,'text'=>"Send List ".$ex[1]." 📥",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "قناة تيم الشايب", 'url' => "https://t.me/TimALshayeb"]],]])]);
file_put_contents('mode', 'roger'.$ex[1]);
}
if (preg_match('/Delet - \d+/',$text)){
$ex = explode('Delet - ',$text);
bot('sendMessage', ['chat_id' => $chat_id,'text'=>"Delet List ".$ex[1]." 🗑",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "قناة تيم الشايب", 'url' => "https://t.me/TimALshayeb"]],]])]);
...
$EzTG->sendMessage(['chat_id'=>$cha,'text'=>"⌁ Done Delet User List 2 : @$user",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "قناة تيم الشايب", 'url' => "https://t.me/TimALshayeb"]],
]])]);
} else {
bot('sendMessage', ['chat_id' => $chat_id, 'text'=>"@$user : Already Exists.",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "قناة تيم الشايب", 'url' => "https://t.me/TimALshayeb"]],
]])]);
}
unlink('mode');
} 
...
bot('sendMessage', ['chat_id' => $chat_id,  'text' => "⌁ Done Delet User List 1 : @$user",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "قناة تيم الشايب", 'url' => "https://t.me/TimALshayeb"]],
]])]);
unlink('mode');
}elseif($mode == 'roger1'){
echo $mode;
...
bot('sendMessage', ['chat_id' => $chat_id,  'text' => "⌁ Done Added Users To List 1 :\n" . countUsers($userT, "1") ,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "قناة تيم الشايب", 'url' => "https://t.me/TimALshayeb"]],
]])]);
unlink('mode');
}
}}
...
bot('sendMessage', ['chat_id' => $chat_id,'text' => "⌁ Done Delet User List 2 : @$user" ,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "قناة تيم الشايب", 'url' => "https://t.me/TimALshayeb"]],
]])]);
unlink('mode');
}elseif($mode == 'roger2'){
echo $mode;
...
$EzTG->sendMessage(['chat_id'=>$cha,'text'=>"@$user : ⌁ Done Pin.",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "قناة تيم الشايب", 'url' => "https://t.me/TimALshayeb"]],
]])]);
} else {
bot('sendMessage', ['chat_id' => $chat_id, 'text'=>"@$user : Already Exists.",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "قناة تيم الشايب", 'url' => "https://t.me/TimALshayeb"]],
]])]);}
...
bot('sendMessage', ['chat_id' => $chat_id,'text' => "⌁ Done Delet User List 3 : @$user",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "قناة تيم الشايب", 'url' => "https://t.me/TimALshayeb"]],
]])]);
unlink('mode');
}elseif($mode == 'roger3'){
echo $mode;
...
bot('sendMessage', ['chat_id' => $chat_id,'text' => "⌁ Done Delet User List 4 : @$user",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "قناة تيم الشايب", 'url' => "https://t.me/TimALshayeb"]],
]])]);
unlink('mode');
}elseif($mode == 'roger4'){
echo $mode;
...
bot('sendMessage', ['chat_id' => $chat_id,'text' => "⌁ Done Delet User List 5 : @$user",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "قناة تيم الشايب", 'url' => "https://t.me/TimALshayeb"]],
]])]);
unlink('mode');
}elseif($mode == 'roger5'){
echo $mode;
...
$list = $list . "\n$i  ➧ @$user";
$i++;}}
bot('sendMessage', ['chat_id' => $chat_id, 'text' => "• The All Users List ".$ex[1]." 📥 \n".$list ,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "قناة تيم الشايب", 'url' => "https://t.me/TimALshayeb"]],
]])]);
}
if (preg_match('/Clear list \d+/',$text)){
$ex = explode('Clear list ',$text);
bot('sendMessage', ['chat_id' => $chat_id, 'text' => "Done Delete all Usernames List 1",'reply_markup'=>json_encode(['inline_keyboard'=>[[['text' => "قناة تيم الشايب", 'url' => "https://t.me/TimALshayeb"]],
]])]);
